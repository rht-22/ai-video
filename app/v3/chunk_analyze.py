...
# 2026-09-08: 표본 4 → 8. EP01 s4c0 이 3/4 불일치로 한 번 반려된 뒤 통과한 답에도 오귀속
# (2549~2556 공사현장 인서트를 '경희의 반응'으로)이 남아 완성본 42~46s 에 들어갔다 — 표본이
# 그 조각을 안 뽑았다. 무성 조각 분위수를 촘촘히(후반 편중 유지), 반려 기준은 3/8.
BINDING_SAMPLE_COUNT = 8
BINDING_REJECT_MIN = 3         # 표본 중 이만큼 불일치면 그 청크 반려
BINDING_QUANTILES = (0.1, 0.25, 0.4, 0.55, 0.7, 0.8, 0.9, 0.97)   # 후반 편중 — 드리프트가 크는 곳
