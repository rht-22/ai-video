...
**상태: E19-1·E19-3 구현 완료(2026-08-28) · 나머지(E19-2·4~8) 기획.** 구현된 항목의
계약 정본은 이제 코드다: ai-video `CLAUDE.md`(채널 톤 프로파일 절 + E19-3 하위 절) ·
`app/modules/style_tone.py` · `pipeline.snap_cues_to_dialogue_gaps` ·
`tests/test_e19_style_tone.py` · `tests/test_e19_cue_overlap.py`.
